...
class EpisodeRenamerUi():
    def __init__(self):
        ...
        self.title_label.config(text="Episode Renamer", font=("Arial", 15, "bold"))
        self.title_label.config(pady=10)
        ...
        self.rename_btn.grid(row=1, column=1)
        ...
        self.unrename_btn.grid(row=1, column=2)
        ...
        self.path_label.grid(row=2, column=0, columnspan=3)
